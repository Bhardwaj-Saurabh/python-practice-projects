...
def check_available_resources(order):
    ingredients = MENU[order]['ingredients']
    if ingredients['water'] < resources['water'] and ingredients.get('milk', 0) < resources['milk'] and ingredients['coffee'] < resources['coffee']:
        return True
    return False
